...
const socialLinks = [
  { href: "https://www.facebook.com/", icon: <FaFacebookF size={16} />, color: "#1877F2" },
  { href: "https://twitter.com/", icon: <FaXTwitter size={16} />, color: "#1DA1F2" },
  { href: "https://www.instagram.com/", icon: <FaInstagram size={16} />, color: "#E1306C" },
  { href: "https://www.youtube.com/", icon: <FaYoutube size={16} />, color: "#FF0000" },
];
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            {quickLinks.map((link, index) => (
              <li key={index}>
                <Link href={link.path} className="hover:text-white transition">
                  {link.name}
                </Link>
              </li>
            ))}
